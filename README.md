...
- 🐑 **[rai](https://github.com/YogevKr/rai)** — Native macOS window for your herdr herd. Fast SwiftUI client over herdr's socket API.
...
<sub>📊 [browse public repos →](https://github.com/YogevKr?tab=repositories)</sub>
